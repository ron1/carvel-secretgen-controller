	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SecretgenV1alpha1().SecretImports(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SecretgenV1alpha1().SecretImports(namespace).Watch(options)
			},
		},
		&secretgenv1alpha1.SecretImport{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *secretImportInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&secretgenv1alpha1.SecretImport{}, f.defaultInformer)
}
